###### Class me.paranoid.wifikill.service.WFKService (me.paranoid.wifikill.service.WFKService)
...
.method private a(ILjava/lang/Object;)V
    ...
    :try_end_1b
    .catch Landroid/os/RemoteException; {:try_start_b .. :try_end_1b} :catch_1f
...
.method private a(Ljava/lang/String;)V
    ...
    :try_end_25
    .catch Ljava/lang/InterruptedException; {:try_start_20 .. :try_end_25} :catch_37
...
.method static synthetic a(Lme/paranoid/wifikill/service/WFKService;Lme/paranoid/wifikill/service/a;)V
    ...
    # ========================================================
    # WHITELIST KONTROLÜ BAŞLANGICI (GRAB / İZLEME İÇİN)
    # ========================================================
    const-string v0, "WiFiKill_Whitelist"
    const/4 v1, 0x0
    invoke-virtual {p0, v0, v1}, Lme/paranoid/wifikill/service/WFKService;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    move-result-object v0
    
    iget-object v1, p1, Lme/paranoid/wifikill/service/a;->a:Ljava/lang/String;
    const/4 v2, 0x0
    invoke-interface {v0, v1, v2}, Landroid/content/SharedPreferences;->getBoolean(Ljava/lang/String;Z)Z
    move-result v0

    if-eqz v0, :cond_safe_cihazi_izleme
    return-void
    :cond_safe_cihazi_izleme
    # ========================================================
...
.method private b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_41
    .catch Ljava/io/FileNotFoundException; {:try_start_30 .. :try_end_41} :catch_42
    .catch Ljava/io/IOException; {:try_start_30 .. :try_end_41} :catch_47
...
.method static synthetic c(Lme/paranoid/wifikill/service/WFKService;)V
    ...
    const-string v1, "iptables -F; iptables -X; iptables -t nat -F; iptables -t nat -X; iptables -P FORWARD ACCEPT; iptables -I FORWARD -j ACCEPT; iptables -t nat -I POSTROUTING -j MASQUERADE; echo 1 > /proc/sys/net/ipv4/ip_forward"
    ...
    :try_end_b3
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_ad .. :try_end_b3} :catch_c8
...
.method static synthetic c(Lme/paranoid/wifikill/service/WFKService;Lme/paranoid/wifikill/service/a;)V
    ...
    # ========================================================
    # WHITELIST KONTROLÜ BAŞLANGICI (KILL / KESME İÇİN)
    # ========================================================
    const-string v0, "WiFiKill_Whitelist"
    const/4 v1, 0x0
    invoke-virtual {p0, v0, v1}, Lme/paranoid/wifikill/service/WFKService;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    ...
    if-eqz v0, :cond_safe_cihazi_kesme
    return-void
    :cond_safe_cihazi_kesme
    # ========================================================
